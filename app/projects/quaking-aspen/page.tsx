...
const schema = {
  ...
  '@graph': [
    ...
    {
      '@type': 'ImageObject',
      '@id': 'https://brebuilders.com/projects/quaking-aspen/#hero-image',
      url: 'https://cdn.jsdelivr.net/gh/brebuilders-new/bre-assets@main/Extensive-Rot-Exposure-Along-Wall-Panel-600x403.jpg',
      contentUrl: 'https://cdn.jsdelivr.net/gh/brebuilders-new/bre-assets@main/Extensive-Rot-Exposure-Along-Wall-Panel-600x403.jpg',
      name: 'Quaking Aspen Structural Repair — Dry Rot Diagnosis Reno NV | BRE Builders',
      description: 'Extensive dry rot exposure along wall panel diagnosed and repaired at Quaking Aspen project, Reno, NV. Full structural remediation. BRE Builders NV #0085999.',
      caption: 'Quaking Aspen structural repair — extensive dry rot exposure diagnosis, Reno NV by BRE Builders',
      ...
      keywords: 'BRE Builders, structural repair Reno NV, dry rot repair, licensed contractor nevada, NV #0085999',
    },
