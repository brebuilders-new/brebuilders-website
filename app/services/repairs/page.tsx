...
export const metadata: Metadata = {
  ...
  description: 'Licensed structural repair contractors in Reno, NV. Foundation repair, dry rot, water intrusion, framing. Free inspection request. NV License #0085999.',
  openGraph: {
