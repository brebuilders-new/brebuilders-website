...
export default function KitchenSignsPage() {
  return (
    <BlogTemplate
      ...
      schema={schema}
      relatedPosts={[
        { title: 'Is Your Kitchen Ruining Your Property Value?', href: '/blog/is-your-kitchen-ruining-your-property-value', category: 'Kitchen', img: 'https://cdn.jsdelivr.net/gh/brebuilders-new/bre-assets@main/2022/08/069e8b9c8f2e2250197256ce430710e4-uncropped_scaled_within_1536_1152-1-1024x768.webp', alt: 'Kitchen property value Reno NV' },
        { title: 'Reno Kitchen Remodeling Trends & Investment Tips for 2025', href: '/blog/reno-kitchen-remodeling-trends', category: 'Kitchen', img: 'https://cdn.jsdelivr.net/gh/brebuilders-new/bre-assets@main/2022/08/069e8b9c8f2e2250197256ce430710e4-uncropped_scaled_within_1536_1152-1-1024x768.webp', alt: 'Reno kitchen remodeling trends' },
