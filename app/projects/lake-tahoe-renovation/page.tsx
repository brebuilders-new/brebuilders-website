...
const PHOTOS = [
  { n: 1, cap: 'Exterior · Renovation Complete', suffix: '' },
  { n: 2, cap: 'Deck & Structure', suffix: '' },
  { n: 3, cap: 'Deck Railing & Walkway', suffix: '' },
  { n: 4, cap: 'Interior Living Space', suffix: '' },
  { n: 5, cap: 'Interior Finish Work', suffix: '' },
  { n: 6, cap: 'Loft & Upper Level', suffix: '' },
  { n: 7, cap: 'Custom Interior Staircase', suffix: '' },
  { n: 8, cap: 'Bathroom Renovation', suffix: '' },
  { n: 9, cap: 'Interior Room', suffix: '' },
  { n: 10, cap: 'Bathroom Installation', suffix: '' },
  { n: 11, cap: 'Interior Staircase', suffix: '' },
  { n: 12, cap: 'Upper Level · Skylights', suffix: '' },
  { n: 13, cap: 'Loft · Natural Light', suffix: '' },
  { n: 14, cap: 'Exterior Deck Renovation', suffix: '' },
  { n: 15, cap: 'Deck Walkway Detail', suffix: '' },
  { n: 16, cap: 'Completed Exterior', suffix: '-1' },
].map(p => ({
