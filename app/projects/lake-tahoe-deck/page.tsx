...
const schema = {
  ...
  '@graph': [
    ...
    {
      '@type': 'ImageObject',
      '@id': 'https://brebuilders.com/projects/lake-tahoe-deck/#hero-image',
      url: 'https://cdn.jsdelivr.net/gh/brebuilders-new/bre-assets@main/Lake-Tahoe-Deck-Reinforcement-%E2%80%93-Steel-Angle-Bracket-System-1000x1000.jpg',
      contentUrl: 'https://cdn.jsdelivr.net/gh/brebuilders-new/bre-assets@main/Lake-Tahoe-Deck-Reinforcement-%E2%80%93-Steel-Angle-Bracket-System-1000x1000.jpg',
      name: 'Lake Tahoe Deck Structural Repair — Steel Angle Bracket System | BRE Builders',
      description: 'Steel angle bracket system anchored to CMU wall restoring structural integrity to cantilevered deck at Lake Tahoe, NV. All hardware galvanized. BRE Builders NV #0085999.',
      caption: 'Lake Tahoe deck structural repair — steel angle bracket system, CMU wall anchor by BRE Builders',
      ...
      keywords: 'BRE Builders, deck structural repair Lake Tahoe, steel bracket deck repair, licensed contractor nevada, NV #0085999',
    },
