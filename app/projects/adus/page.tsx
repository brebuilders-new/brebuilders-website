...
const schema = {
  ...
  '@graph': [
    ...
    {
      '@type': 'ImageObject',
      '@id': 'https://brebuilders.com/projects/adus/#hero-image',
      url: 'https://cdn.jsdelivr.net/gh/brebuilders-new/bre-assets@main/adu-homepage-600x403.jpg',
      contentUrl: 'https://cdn.jsdelivr.net/gh/brebuilders-new/bre-assets@main/adu-homepage-600x403.jpg',
      name: 'ADU Construction Reno NV — BRE Builders Portfolio',
      description: 'ADU backyard home construction in Reno, NV. Complete builds $75K–$300K including permits. BRE Builders licensed general contractor NV #0085999.',
      caption: 'ADU construction portfolio — Reno NV by BRE Builders NV #0085999',
      ...
      keywords: 'BRE Builders, ADU construction Reno NV, accessory dwelling unit, licensed contractor nevada, NV #0085999',
    },
