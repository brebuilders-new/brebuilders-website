      ...
      >
        <div className="max-w-[1400px] mx-auto px-5 lg:px-10 h-[68px] flex items-center justify-between">
          ...
          <div className="flex lg:hidden items-center gap-2.5 flex-shrink-0">
            <a href={SITE.phoneHref} className="flex items-center gap-1.5 bg-gold text-void rounded-lg px-3 py-2 text-[12px] font-mono font-semibold hover:opacity-90 transition-opacity" aria-label={`Call ${SITE.phone}`}>
