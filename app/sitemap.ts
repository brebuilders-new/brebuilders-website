...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    // ── Tier 1: Core — verified GSC rankings ─────────────────────────────
    { url: base + '/',                                             lastModified: now, changeFrequency: 'weekly',  priority: 1.0  },
    { url: base + '/adus/',                                        lastModified: now, changeFrequency: 'monthly', priority: 0.95 },
    { url: base + '/repairs/',                                     lastModified: now, changeFrequency: 'monthly', priority: 0.95 },
    ...
    { url: base + '/additions/',                                   lastModified: now, changeFrequency: 'monthly', priority: 0.85 },
    ...
    { url: base + '/warehouse-metal-buildings/',                   lastModified: now, changeFrequency: 'monthly', priority: 0.75 },
    { url: base + '/retail/',                                      lastModified: now, changeFrequency: 'monthly', priority: 0.70 },
    { url: base + '/office/',                                      lastModified: now, changeFrequency: 'monthly', priority: 0.70 },
    { url: base + '/lofts-and-condo-remodels/',                    lastModified: now, changeFrequency: 'monthly', priority: 0.70 },
    { url: base + '/residential-services/',                        lastModified: now, changeFrequency: 'monthly', priority: 0.65 },

    // ── Tier 3: Portfolio ─────────────────────────────────────────────────
    { url: base + '/projects/',                                    lastModified: now, changeFrequency: 'monthly', priority: 0.80 },
    { url: base + '/portfolio/lake-tahoe-interior-renovation-project-bre-builders/', lastModified: now, changeFrequency: 'monthly', priority: 0.80 },
    { url: base + '/portfolio/ripon-california-estate-project/',   lastModified: now, changeFrequency: 'monthly', priority: 0.75 },
    { url: base + '/portfolio/adus/',                              lastModified: now, changeFrequency: 'monthly', priority: 0.70 },
    { url: base + '/portfolio/lake-tahoe-deck-balcony-structural-repair/', lastModified: now, changeFrequency: 'monthly', priority: 0.65 },
    { url: base + '/portfolio/rio-tinto-home-renovation-project/', lastModified: now, changeFrequency: 'monthly', priority: 0.60 },
    { url: base + '/portfolio/warehouse-metal-buildings/',         lastModified: now, changeFrequency: 'monthly', priority: 0.60 },

    // ── Tier 4: Service areas ─────────────────────────────────────────────
    { url: base + '/service-areas/',                               lastModified: now, changeFrequency: 'monthly', priority: 0.85 },
    { url: base + '/service-areas/nevada/',                        lastModified: now, changeFrequency: 'monthly', priority: 0.85 },
    ...
    { url: base + '/blogs/',                                       lastModified: now, changeFrequency: 'weekly',  priority: 0.65 },

    // ── Tier 6: Blog posts ────────────────────────────────────────────────
    { url: base + '/how-to-add-an-adu-in-nevada-without-breaking-the-bank-2025-guide/', lastModified: now, changeFrequency: 'weekly',  priority: 0.80 },
    { url: base + '/top-10-signs-your-home-needs-structural-repair-dont-ignore-3/',     lastModified: now, changeFrequency: 'monthly', priority: 0.70 },
    { url: base + '/deck-safety-warning-signs-reno-lake-tahoe/',                        lastModified: now, changeFrequency: 'monthly', priority: 0.70 },
    { url: base + '/reno-kitchen-remodeling-top-trends-investment-tips-for-2025/',      lastModified: now, changeFrequency: 'monthly', priority: 0.65 },
    { url: base + '/is-your-kitchen-ruining-your-property-value-fix-these-5-things-first/', lastModified: now, changeFrequency: 'monthly', priority: 0.65 },
    { url: base + '/5-signs-its-time-to-remodel-your-kitchen-2-hurts-your-home-value/', lastModified: now, changeFrequency: 'monthly', priority: 0.65 },
    { url: base + '/from-strikes-to-suds-how-bre-builders-saved-a-reno-icon/',          lastModified: now, changeFrequency: 'monthly', priority: 0.60 },
    { url: base + '/reno-home-repairs-20-year-old-house/',                              lastModified: now, changeFrequency: 'monthly', priority: 0.60 },
    { url: base + '/reno-home-repairs-30-year-old-house/',                              lastModified: now, changeFrequency: 'monthly', priority: 0.60 },
    ...
    { url: base + '/what-reno-homeowners-overlook-in-10-year-old-homes/',               lastModified: now, changeFrequency: 'monthly', priority: 0.55 },

    // ── Tier 7: Legal (indexed, lower priority) ───────────────────────────
