...
export const metadata: Metadata = {
  ...
  openGraph: {
    images: [{ url: `${SITE_URL}/api/og?title=Glenbrook+Lake+Tahoe+Renovation&sub=619+Lakeview+Dr+%C2%B7+Full+Home+Renovation+%C2%B7+37+Photos&badge=Portfolio`, width: 1200, height: 630,
      alt: 'Blue Reef Builders — Glenbrook Lake Tahoe Full Home Renovation | Glenbrook, Lake Tahoe | BRE Builders', }],
  },
  robots: { index: true, follow: true, 'max-image-preview': 'large', 'max-snippet': -1 },
  twitter: {
    card: 'summary_large_image',
    title: 'Glenbrook Lake Tahoe Full Home Renovation | Glenbrook, Lake Tahoe | BR',
    description: 'Full home renovation at Glenbrook, Lake Tahoe, Lake Tahoe NV. Structural upgrades, interior renovation, exterior work. 37-photo portfolio. BRE Builders NV ',
    images: [{ url: `${SITE_URL}/api/og?title=Glenbrook+Lake+Tahoe+Renovation&sub=619+Lakeview+Dr+%C2%B7+Full+Home+Renovation+%C2%B7+37+Photos&badge=Portfolio`, alt: 'Blue Reef Builders — Glenbrook Lake Tahoe Full Home Renovation | Glenbrook, Lake Tahoe | BRE Builders' }],
  },
...
const schema = {
  ...
  '@graph': [
    ...
    {
      '@type': 'ImageObject',
      '@id': 'https://brebuilders.com/projects/glenbrook-lake-tahoe/#hero-image',
      url: `${CDN}/2025/12/01-619-Lakeview-Dr-Glenbrook-NV-89413-1-of-37.webp`,
      contentUrl: `${CDN}/2025/12/01-619-Lakeview-Dr-Glenbrook-NV-89413-1-of-37.webp`,
      name: 'Glenbrook Lake Tahoe Full Home Renovation — BRE Builders',
      description: 'Full home renovation at 619 Lakeview Dr, Glenbrook, Lake Tahoe NV. BRE Builders licensed general contractor NV #0085999.',
      caption: 'Glenbrook Lake Tahoe full home renovation exterior — BRE Builders NV #0085999',
      ...
      keywords: 'BRE Builders, glenbrook lake tahoe renovation, full home renovation, licensed contractor nevada',
    },
