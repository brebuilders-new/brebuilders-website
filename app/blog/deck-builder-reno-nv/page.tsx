  ...
  '@graph': [
    ...
    },
    {
      ...
      mainEntity: [
        ...
        { '@type': 'Question', name: 'Does BRE Builders build decks at Lake Tahoe?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. BRE Builders builds and repairs decks throughout Lake Tahoe — Nevada and California sides. Lake Tahoe decks require snow-load rated structural design. NV #0085999 · CA #1093798.' } },
      ],
    },
  ],
}
