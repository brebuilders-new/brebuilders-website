...
const schema = {
  ...
  '@graph': [
    ...
    {
      '@type': 'ImageObject',
      '@id': 'https://brebuilders.com/projects/car-wash/#hero-image',
      url: 'https://cdn.jsdelivr.net/gh/brebuilders-new/bre-assets@main/Commercial-Concrete-Slab-Pour-with-Utility-Access-%E2%80%93-Reno-NV-1000x1000.jpg',
      contentUrl: 'https://cdn.jsdelivr.net/gh/brebuilders-new/bre-assets@main/Commercial-Concrete-Slab-Pour-with-Utility-Access-%E2%80%93-Reno-NV-1000x1000.jpg',
      name: 'Commercial Concrete Slab Pour Car Wash Reno NV — BRE Builders',
      description: 'Commercial concrete slab construction with utility access for car wash facility in Reno, NV. BRE Builders licensed general contractor NV #0085999.',
      caption: 'Commercial concrete slab pour with utility access — Reno NV car wash by BRE Builders',
      ...
      keywords: 'BRE Builders, commercial concrete Reno NV, concrete slab construction, licensed contractor nevada, NV #0085999',
    },
