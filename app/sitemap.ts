...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: base + '/portfolio/lake-tahoe-interior-renovation-project-bre-builders/', lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    ...
    { url: base + '/service-areas/nevada/',     lastModified: now, changeFrequency: 'monthly', priority: 0.8  },
    { url: base + '/service-areas/lake-tahoe/', lastModified: now, changeFrequency: 'monthly', priority: 0.8  },
    { url: base + '/service-areas/northern-california/', lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    { url: base + '/service-areas/sparks/',     lastModified: now, changeFrequency: 'monthly', priority: 0.7  },
    { url: base + '/service-areas/carson-city/', lastModified: now, changeFrequency: 'monthly', priority: 0.7  },
    { url: base + '/service-areas/truckee/',    lastModified: now, changeFrequency: 'monthly', priority: 0.7  },
    ...
    { url: base + '/deck-safety-warning-signs-reno-lake-tahoe/',                        lastModified: now, changeFrequency: 'monthly', priority: 0.65 },
