...
// All values verified from live site scrape — April 2026.
// DO NOT modify without verifying against BRE_MASTER_CONTENT_STRATEGY.md
...
export const SITE = {
  ...
  addressZip: '89502',
  nvLicense: '0085999',
  caLicense: 'VERIFY_WITH_CLIENT', // ⚠️ 1009219 vs 1093798 — confirm before publishing
  founded: '1989',
  experience: '35+',
...
export const SERVICE_AREAS = [
  ...
  { name: 'Lake Tahoe', state: 'NV', slug: 'lake-tahoe' },
  { name: 'Carson City', state: 'NV', slug: 'carson-city' },
  { name: 'Truckee', state: 'CA', slug: 'truckee' },
  { name: 'Graeagle', state: 'CA', slug: 'graeagle' },
  { name: 'Northern California', state: 'CA', slug: 'northern-california' },
  { name: 'Carson Valley', state: 'NV', slug: 'carson-valley' },
] as const
...
export const TESTIMONIALS = [
  ...
  {
    // ⚠️ Name conflict: "Stephanie" on homepage, "Carmel" on service pages — using "Stephanie" pending client confirm
    name: 'Stephanie',
    location: 'Reno, NV',
...
export const SERVICES = [
  {
    ...
    metaDescription: 'BRE Builders provides ADU construction in Reno, NV. Licensed in Nevada & California. $75K–$300K complete builds. Permit-ready plans. Free quote in 24 hours.',
    isHighPriority: true, // #1 ranking — handle with care
  },
  {
    slug: 'repairs',
    ...
    seoTitle: 'Structural Repairs Reno NV | Licensed Contractor | BRE Builders',
    metaDescription: 'Structural repairs in Reno, NV — foundation repair, water intrusion, dry rot, framing. Licensed contractor. Prompt response. Free inspection request.',
    isHighPriority: true, // Page 1 ranking
  },
  {
    slug: 'kitchen-bath',
    name: 'Kitchen & Bath',
    ...
    metaDescription: 'Kitchen and bathroom remodeling in Reno, NV. High-quality finishes, modern layouts. Licensed contractor, free estimates. BRE Builders.',
  },
  {
    slug: 'new-home',
    ...
    metaDescription: 'Custom home building in Reno, NV and Northern California. In-house design-build team. Licensed NV & CA. Free consultations. BRE Builders.',
  },
  {
    slug: 'decks',
    name: 'Decks',
    ...
    metaDescription: 'Deck construction and repair in Reno, Sparks & Lake Tahoe. New builds and structural restoration. Licensed contractor. Free estimates. BRE Builders.',
  },
  {
    slug: 'additions',
    name: 'Home Additions',
    ...
    seoTitle: 'Home Additions Reno NV | Room Additions | BRE Builders',
    metaDescription: 'Home additions and room expansions in Reno, NV. Licensed general contractor. Add square footage without the cost of moving. Free estimates.',
  },
  {
    slug: 'lofts-condos',
    ...
    metaDescription: 'Loft and condo remodeling in Reno, NV. Modern upgrades for urban living spaces. Licensed contractor. Free estimates. BRE Builders.',
  },
  {
    slug: 'commercial',
    ...
    metaDescription: 'Commercial construction in Reno, NV — tenant improvements, office buildouts, warehouses. Licensed NV & CA. Free estimates. BRE Builders.',
  },
  {
    slug: 'retail',
    ...
    seoTitle: 'Retail Construction Reno NV | Tenant Improvements | BRE Builders',
    metaDescription: 'Retail construction and tenant improvements in Reno, NV. Licensed general contractor. Free estimates. BRE Builders.',
  },
  {
    slug: 'office',
    ...
    metaDescription: 'Office construction and tenant improvements in Reno, NV. Modern, functional spaces. Licensed contractor. Free estimates. BRE Builders.',
  },
  {
    slug: 'warehouse',
    ...
    metaDescription: 'Warehouse and metal building construction in Reno, NV. Custom, scalable, code-compliant. Licensed contractor. Free estimates. BRE Builders.',
  },
  {
    slug: 'concrete',
    name: 'Concrete',
    ...
    metaDescription: 'Concrete contractor in Reno, NV. Foundations, slabs, driveways, commercial concrete. Licensed contractor. Free estimates. BRE Builders.',
  },
  {
    slug: 'hauling',
    ...
    seoTitle: 'Hauling & Removal Reno NV | Debris Cleanup | BRE Builders',
    metaDescription: 'Hauling and removal services in Reno, NV. Construction debris, yard waste, appliance hauling. Fast and clean. BRE Builders.',
  },
] as const
...
export const FAQS = [
  {
    q: 'Who is BRE Builders?',
    a: 'BRE Builders is a licensed, locally owned and operated home improvement contractor serving Reno, Sparks, Carson City, and surrounding areas. We specialize in structural repairs, custom remodeling, ADUs, deck restoration, waterproofing, and more. We deliver reliable, code-compliant, and long-lasting solutions.',
  },
  {
    q: 'What areas do you serve?',
    a: 'We proudly serve Reno, NV; Sparks, NV; Carson City, NV; Lake Tahoe & Truckee, CA; and Carson Valley & surrounding communities. Contact us to discuss service outside these areas.',
  },
  {
    q: 'What services do you provide?',
    a: 'We offer structural repairs & home stabilization, deck safety inspections & full rebuilds, waterproofing & custom railings, kitchen & bathroom remodels, new home additions & ADU construction, concrete slab work and framing, and office & commercial renovations.',
  },
  {
    q: 'Do you handle permit and code compliance?',
    a: 'Yes. BRE Builders manages the entire permitting process and ensures all projects meet local Nevada and California building codes. We never cut corners.',
  },
  {
    q: 'Do you offer free estimates?',
    a: 'Absolutely. We provide free, no-obligation estimates after a site visit. Get started by filling out our project form or calling us directly.',
  },
  {
    q: 'How soon can you start my project?',
    a: 'Project timelines vary based on season and project scope. Once a contract is signed and permits (if any) are secured, we typically begin within 1–2 weeks.',
  },
  {
    q: 'How long will my project take?',
    a: 'Minor repairs: 1–3 days. Deck rebuilds: 3–7 days. Kitchen remodels: 2–3 weeks. ADU builds: 1.5–3 months. We provide detailed timelines during the quote process.',
  },
  {
    q: 'Will you help me stay within my budget?',
    a: 'Yes. We offer tiered pricing options and value-engineered alternatives to make your project affordable without compromising quality. Ask us how we can reduce costs.',
  },
  {
    q: 'What kind of materials do you use?',
    a: 'We use high-grade, weather-tested, and code-approved materials, including Trex decking, pressure-treated lumber, composite siding, and premium waterproofing membranes. All material choices are discussed with the client.',
  },
  {
    q: 'Do your projects come with a warranty?',
    a: 'Yes. We offer a 1-year workmanship warranty on all projects and pass on manufacturer warranties where applicable.',
  },
  {
    q: 'Are you licensed and insured?',
    a: 'Yes. BRE Builders is fully licensed, bonded, and insured in Nevada and California. Nevada License #0085999.',
  },
  {
    q: 'Can you provide references or photos of past work?',
    a: 'Of course. Visit our portfolio or contact us for direct client referrals.',
  },
  {
    q: 'What payment methods do you accept?',
    a: 'We accept checks, bank transfers, and credit card payments. A deposit is required upon contract signing, with milestone-based payments throughout.',
  },
  {
    q: 'Do you offer financing options?',
    a: 'We are working with third-party lenders to provide flexible home improvement financing. Ask about current availability when requesting your quote.',
  },
  {
    q: 'Can I legally build an ADU in Reno or Carson City?',
    a: 'Yes — but there are zoning, lot-size, and occupancy rules. We help homeowners navigate all ADU permits and designs based on your property\'s zoning laws.',
  },
] as const

// Lake Tahoe 16-image gallery
export const LT_GALLERY = Array.from({ length: 16 }, (_, i) => {
  ...
  const captions = [
    ...
    'Loft and Upper-Level Renovation',
    'Custom Interior Stair Construction',
    'Bathroom Renovation',
    'Interior Room Renovation',
    'Bathroom Installation Phase',
    'Interior Staircase View',
    'Upper-Level Interior Renovation',
    'Loft Area Renovation',
    'Exterior Deck Renovation',
    'Deck Walkway Detail',
    'Completed Exterior Renovation',
  ]
  const alts = [
    'Full Home Renovation Exterior 695 Lakeview Blvd Zephyr Cove Lake Tahoe',
    'Exterior Deck and Structural Renovation Lake Tahoe Zephyr Cove',
    'Deck Railing and Walkway Renovation Lake Tahoe NV',
    'Interior Living Space Renovation Lake Tahoe Home',
    'Interior Finish Work and Updated Materials Lake Tahoe Renovation',
    'Loft and Upper Level Renovation Lake Tahoe Home',
    'Custom Interior Stair Construction Lake Tahoe Full Renovation',
    'Bathroom Renovation with Updated Fixtures Lake Tahoe',
    'Interior Room Renovation Updated Finishes Lake Tahoe Home',
    'Bathroom Installation Vanity and Tub Lake Tahoe Renovation',
    'Interior Staircase Connecting Multiple Renovated Levels Lake Tahoe',
    'Upper Level Interior Renovation Skylights and Railing Lake Tahoe',
    'Loft Area Renovation with Natural Light Open Layout Lake Tahoe',
    'Exterior Deck Renovation Updated Materials and Railing Lake Tahoe',
    'Deck Walkway Detail Railing and Surface Upgrades Lake Tahoe',
    'Completed Full Home Renovation Exterior Lake Tahoe BRE Builders',
  ]
  return {
