        ...
        <section className="py-20 bg-panel border-t border-white/[0.05]">
          <div className="container">
            ...
            <h2 className="font-display font-light text-[clamp(24px,3.5vw,44px)] leading-tight text-cream mb-8">
              Real Work.<br /><span className="italic text-teal">Reno-Sparks Metro.</span>
            </h2>
            <GalleryGrid
              mode="grid"
              images={[
        ...
        <section className="py-10 bg-deep border-t border-white/[0.05]">
          <div className="container">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <Link href="/blog/reno-home-10-year-maintenance" className="font-mono text-[11px] text-cream/45 hover:text-teal border border-white/[0.08] hover:border-teal/25 px-3 py-1.5 rounded-full transition-all bg-white/[0.02]">10-Year Reno Home Maintenance →</Link>
              <Link href="/services/adu/" className="font-mono text-[11px] text-cream/45 hover:text-teal border border-white/[0.08] hover:border-teal/25 px-3 py-1.5 rounded-full transition-all bg-white/[0.02]">ADU Builders Sparks NV →</Link>
              <Link href="/services/kitchen-bath/" className="font-mono text-[11px] text-cream/45 hover:text-teal border border-white/[0.08] hover:border-teal/25 px-3 py-1.5 rounded-full transition-all bg-white/[0.02]">Kitchen Remodels Sparks →</Link>
            </div>
          </div>
        </section>
