      ...
      <main>
        ...
        <section className="md:hidden relative overflow-hidden">
          <div className="relative w-full" style={{ height: '42vw', minHeight: 150, maxHeight: 220 }}>
            ...
            <img src={IMGS.lt(7)} alt="Custom Interior Stair Construction Lake Tahoe BRE Builders craftsmanship" className="w-full h-full object-cover" fetchPriority="high" style={{ objectPosition: '50% 35%' }} />
          ...
          <div className="bg-deep px-5 pt-5 pb-6">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="font-mono text-[9px] tracking-[2.5px] uppercase text-teal">How We Work</span>
            </div>
        ...
        <section className="hidden md:relative md:block md:flex min-h-[55vh] md:flex-col justify-end pb-14 pt-28 overflow-hidden">
          {/* eslint-disable-next-line @next/next/no-img-element */}
