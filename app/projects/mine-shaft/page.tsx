...
const schema = {
  ...
  '@graph': [
    ...
    {
      '@type': 'ImageObject',
      '@id': 'https://brebuilders.com/projects/mine-shaft/#hero-image',
      url: 'https://cdn.jsdelivr.net/gh/brebuilders-new/bre-assets@main/Close-Up-of-Structural-Wall-with-Custom-Openings-600x403.jpg',
      contentUrl: 'https://cdn.jsdelivr.net/gh/brebuilders-new/bre-assets@main/Close-Up-of-Structural-Wall-with-Custom-Openings-600x403.jpg',
      name: 'Mine Shaft Framing — Structural Wall Custom Openings Reno NV | BRE Builders',
      description: 'Custom structural wall framing with engineered openings for mine shaft conversion project in Reno, NV. BRE Builders licensed general contractor NV #0085999.',
      caption: 'Mine shaft framing — structural wall with custom openings, Reno NV by BRE Builders',
      ...
      keywords: 'BRE Builders, custom framing Reno NV, structural wall construction, licensed contractor nevada, NV #0085999',
    },
