...
export const metadata: Metadata = {
  ...
  openGraph: {
    images: [{
      ...
      alt: 'Blue Reef Builders — Lake Tahoe Full Home Renovation | Portfolio',
    }],
  },
  ...
  twitter: {
    ...
    title: 'Lake Tahoe Full Home Renovation | Portfolio',
    description: 'Zephyr Cove, Lake Tahoe, NV — complete interior and exterior renovation by BRE Builders. 16 photos + project video.',
    images: [{ url: `${SITE_URL}/api/og?title=Lake+Tahoe+Full+Home+Renovation&sub=695+Lakeview+Blvd%2C+Zephyr+Cove%2C+NV+%C2%B7+16+Photos&badge=Portfolio`, alt: 'Blue Reef Builders — Lake Tahoe Full Home Renovation | Portfolio' }],
  },
...
const schema = {
  ...
  '@graph': [
    ...
    {
      '@type': 'ImageObject',
      '@id': 'https://brebuilders.com/projects/lake-tahoe-renovation/#hero-image',
      url: `${BASE}/01-695-Lakeview-Blvd-Zephyr-Cove-NV-89448-1-of-16-1024x684.webp`,
      contentUrl: `${BASE}/01-695-Lakeview-Blvd-Zephyr-Cove-NV-89448-1-of-16-1024x684.webp`,
      name: 'Lake Tahoe Full Home Renovation Exterior — BRE Builders',
      description: 'Completed exterior renovation at 695 Lakeview Blvd, Zephyr Cove, Lake Tahoe NV. Structural upgrades, deck integration, new siding. BRE Builders NV #0085999.',
      ...
      keywords: 'BRE Builders, lake tahoe renovation, full home renovation, licensed contractor nevada, NV #0085999',
    },
